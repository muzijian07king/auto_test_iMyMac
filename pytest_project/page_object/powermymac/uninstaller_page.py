...
class UninstallerPage(WebPage):
    ...
    def download_container_ppm(self):
        """点击下载按钮"""
        self.is_click(uninstaller['container-download'], 1)
    ...
    def download_summary_ppm(self):
        """点击下载按钮"""
        self.is_click(uninstaller['summary-download'], 1)
    ...
    def download_navbar_ppm(self):
        """点击下载按钮"""
        self.is_click(uninstaller['navbar-download'], 1)
    ...
    def assert_popup_nav(self):
        self.allure_assert('判断是否弹出导航栏', ('eq', self.is_display(uninstaller['navbar']), True))
