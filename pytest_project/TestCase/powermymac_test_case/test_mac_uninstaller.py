...
from pytest_project.page_object.powermymac.uninstaller_page import UninstallerPage
...
class TestBody(object):
    ...
    def test_001(self):
        ...
        self.driver.download_mac_cleaner(uninstaller['free-download'])
    ...
    def test_002(self):
        ...
        self.driver.goto_buy(uninstaller['buy'])
    ...
    def test_003(self):
        ...
        self.driver.click_link(uninstaller['guide'])
        assert self.driver.is_goto_guide()

    @allure.title('进入mac-uninstaller首页')
    def test_004(self):
        """去mac-uninstaller首页"""
        allure.dynamic.tag('去mac-uninstaller产品主页')
    ...
    def test_007(self):
        ...
        allure.dynamic.tag('去mac-uninstaller产品主页')
        self.driver.scroll_to_menu()
        self.driver.click_link(get_branch_all_value().get_branch_all_value(uninstaller.data, 'menu')[0])
        assert self.driver.is_cleaner_index()
    ...
    def test_009(self):
        ...
        self.driver.scroll_to_menu()
        self.driver.download_mac_cleaner(get_branch_all_value().get_branch_all_value(uninstaller.data, 'menu')[2])
        assert self.driver.is_download()
    ...
    def test_011(self):
        ...
        self.driver.download_mac_cleaner(get_branch_all_value().get_branch_all_value(uninstaller.data, 'footbuy')[0])
        assert self.driver.is_download()
    ...
    def test_012(self):
        ...
        allure.dynamic.tag('点击buy按钮')
        self.driver.scroll_to_footerBg()
        self.driver.goto_buy(get_branch_all_value().get_branch_all_value(uninstaller.data, 'footbuy')[1])
        assert self.driver.is_goto_buy()

    @allure.title('技巧栏链接测试')
    @pytest.mark.parametrize('link', get_recursion_key().get_recursion_key(uninstaller.data)[4:8])
    ...
    @allure.title('Key Features Mac Uninstaller轮播图的切换测试')
    def test_014(self):
        """Key Features Mac Uninstaller轮播图的切换测试"""
